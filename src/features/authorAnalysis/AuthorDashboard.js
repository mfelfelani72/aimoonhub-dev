      ...
      <div className="container mx-auto mb-3">
        <div className="flex">
          ...
          <div className="basis-1/3 self-center">
            <div className="text-[0.8rem] text-slate-800 pt-1 text-center">
              <a href="{author?.biographyUrl}" target="_blank">
                <div className="text-[0.7rem] text-justify">{author?.biography}</div>
              </a>
            </div>
          </div>
          <div className="basis-1/3 self-center max-h-[7rem] overflow-y-auto border-2 shadow-inner bg-slate-50 mx-2">
           <div className="flex">
            <img className="h-7 w-7" src={defaultImage} />
            <div className="text-[0.7rem] m-2">name</div>
           </div>
           <div className="flex">
            <img className="h-7 w-7" src={defaultImage} />
            <div className="text-[0.7rem] m-2">name</div>
