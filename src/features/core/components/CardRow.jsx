...
const CardRow = (props) => {
  ...
  return (
    <div className="flex flex-row px-2 ltr:md:pr-6 rtl:md:pl-6 ltr:bi:pr-6 rtl:bi:pl-6 rtl:lg:px-6 pt-1 pb-2 border-b bg-slate-50 dark:bg-DB-dim border-color-theme-light dark:border-D-color-theme-light">
      <img
